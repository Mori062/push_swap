...
/*   Updated: 2023/08/20 09:10:18 by morishitash      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sandclock_init(size_t *i, size_t *num, size_t *rr_chance)
{
	*i = 0;
	*num = 0;
	*rr_chance = 0;
...
void	make_sandclock(t_dock **dock, size_t index_max, size_t block_num)
{
	size_t	i;
	size_t	num;
	size_t	rr_chance;

	sandclock_init(&i, &num, &rr_chance);
